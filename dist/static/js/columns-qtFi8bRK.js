import{r as e}from"./rolldown-runtime-DMcso9tT.js";import{K as t,St as n,bt as r,lt as i}from"./vue.runtime.esm-bundler-DvpurtHF.js";import{Ot as a,aa as o,ia as s,wt as c}from"./index-CzLWWCn6.js";import{t as l}from"./data-C_RAKljx.js";var u=e({useColumns:()=>d});o();function d(){let e=n([]),o=n(!0),u=n(`no`),d=n(`nohide`),f=n(`default`),p=n(`right`),m=[{type:`selection`,align:`left`,reserveSelection:!0,hide:()=>u.value===`no`},{label:`日期`,prop:`date`,hide:()=>d.value===`hideDate`},{label:`姓名`,prop:`name`,hide:()=>d.value===`hideName`},{label:`地址`,prop:`address`,hide:()=>d.value===`hideAddress`}],h=r({pageSize:10,currentPage:1,pageSizes:[10,15,20],total:0,align:`right`,background:!0,size:`default`}),g=r({text:`正在加载第一页...`,viewBox:`-10, -10, 50, 50`,spinner:`
        <path class="path" d="
          M 30 15
          L 28 17
          M 25.61 25.61
